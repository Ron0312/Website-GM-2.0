        ...
        <section className="bg-gas-dark py-24 text-white relative overflow-hidden" id="kontakt">
            ...
            <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
                ...
                <div className="bg-white rounded-2xl p-8 md:p-12 shadow-2xl text-left max-w-2xl mx-auto text-text transform hover:-translate-y-1 transition-transform duration-500">
                    <form className="space-y-6" onSubmit={(e) => { if (honeypot) { e.preventDefault(); return; } }}>
                        {/* Honeypot field */}
                        <input
                            type="text"
                            name="b_field"
                        ...
                        <button type="submit" className="w-full bg-gas hover:bg-gas-dark text-white font-bold py-4 rounded-lg transition-all uppercase tracking-wide shadow-lg hover:shadow-xl transform active:scale-95">Anfrage absenden</button>
                    </form>
                </div>
            </div>
        </section>
