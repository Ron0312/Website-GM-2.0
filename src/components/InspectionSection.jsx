        ...
        <section id="pruefungen" className="bg-white">
            ...
            <div className="relative bg-gray-900 py-32 lg:py-48 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img src="https://images.unsplash.com/photo-1621905251189-08b95d630445?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" alt="Technische Prüfung Flüssiggastank" className="w-full h-full object-cover opacity-30 mix-blend-overlay" />
