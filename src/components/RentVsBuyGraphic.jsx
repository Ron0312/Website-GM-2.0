    ...
    <div className="bg-white border border-gray-200 rounded-xl p-8 my-8 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-end justify-center h-72 pb-2">
            <div className="flex-1 flex flex-col items-center justify-end h-full w-full">
                <div className="text-xs text-gray-500 mb-2 font-medium text-center">Hohe laufende Kosten<br/>(Gaspreisbindung & Miete)</div>
                ...
                <div className="mt-4 font-bold text-gray-700 flex items-center"><Lock size={16} className="mr-2 text-red-500"/> Miettank</div>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-end h-full w-full">
                ...
                <div className="mt-4 font-bold text-gray-700 flex items-center"><Unlock size={16} className="mr-2 text-green-600"/> Kauftank</div>
                <div className="text-xs text-gray-500 mt-2 font-medium text-center">Günstigeres Gas<br/>(Freier Markt)</div>
            </div>
        </div>
        <p className="text-[10px] text-gray-400 mt-8 text-center italic border-t border-gray-100 pt-4">
            *Beispielhafte Gesamtkostenrechnung über 10 Jahre inkl. Wartung, Tankmiete/Kauf und Gasverbrauch (2.500L/Jahr).
        </p>
    </div>
);
