...
export const ImprintContent = () => (
    <div className="space-y-4 text-sm text-gray-700">
        ...
        <p>
            ...
            <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-gas hover:underline ml-1">
...
export const PrivacyContent = () => (
    <div className="space-y-4 text-sm text-gray-700">
        ...
        <h3 className="text-lg font-bold text-gray-900 mt-4">2. Allgemeine Hinweise und Pflichtinformationen</h3>
