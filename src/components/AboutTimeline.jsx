...
const AboutTimeline = () => (
    <div className="py-16 bg-white">
        ...
        <div className="max-w-3xl mx-auto px-4 border-l-2 border-gas/20 ml-4 md:ml-auto space-y-12">
            {[
                { year: "2000", title: "Gründung", text: "Gründung durch Kai-Uwe Christen. Alles begann durch Zufall mit der Vermittlung eines gebrauchten Flüssiggastanks." },
                { year: "2012", title: "Expansion", text: "Erweiterung des Liefergebiets auf ganz Mecklenburg-Vorpommern und Hamburg." },
                ...
                { year: "2025", title: "25 Jahre Jubiläum", text: "Wir feiern ein Vierteljahrhundert Flüssiggas on Net – ehrlich, norddeutsch, unabhängig." }
            ].map((item, i) => (
